    ...
    return (
        <div className="w-full min-h-screen flex items-center justify-center bg-background ">
            <motion.div
                ...
                className="min-h-[80vh] bg-background px-4 sm:px-8 flex flex-col justify-start items-center pt-8 gap-8 w-full"
            >
                <motion.div variants={itemVariants} className="text-center z-10 max-w-2xl">
                ...
                <div className="contactForm flex flex-col md:flex-row items-center md:items-stretch gap-8 w-full max-w-7xl mt-4">

                    <motion.div
                        variants={itemVariants}
                        className="getintouch flex flex-col justify-center gap-4 w-full md:w-1/2 text-center md:text-left items-center md:items-start px-2"
                    >
                    ...
                    <motion.form
                        ...
                        className="sendmsg w-full md:w-1/2 bg-card flex flex-col gap-4 p-5 sm:p-8 rounded-2xl border border-border shadow-sm relative hover:shadow-glow transition-shadow duration-300 overflow-hidden group"
                    >
                        ...
                        <div className="submit flex flex-col-reverse sm:flex-row justify-between items-center gap-3 mt-2 relative z-10">
                            ...
                            <motion.button
                                ...
                                className={`p-2.5 bg-active-button rounded-xl text-white px-5 transition-colors duration-300 flex items-center justify-center gap-2 w-full sm:w-auto
                                ${isSubmitting ? 'opacity-70 cursor-wait' : 'hover:shadow-md'}`}
                            >
                                {!isSubmitting && (
