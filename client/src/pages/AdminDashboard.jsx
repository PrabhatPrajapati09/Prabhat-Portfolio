...
const AdminDashboard = () => {
    ...
    return (
        <div className={theme}>
            ...
            <div className='min-h-screen flex flex-col items-center pt-24 pb-10 gap-6 bg-background transition-colors duration-300 overflow-hidden'>
                        ...
                        <div className='flex gap-4 p-2 bg-card rounded-2xl border border-border shadow-sm'>
                            <ul className='flex items-center gap-2 text-secondary-text'>
                                <motion.li
                                    ...
                                    className={`rounded-xl px-4 py-2 cursor-pointer transition-colors duration-300 ${activeTab === 'analytics' ? 'bg-active-button text-white shadow-md' : 'hover:text-primary-text hover:bg-background'}`}
                                >
                                    Analytics
                                </motion.li>
                                <motion.li
                                    ...
                                    className={`rounded-xl px-4 py-2 cursor-pointer transition-colors duration-300 ${activeTab === 'portfolio' ? 'bg-active-button text-white shadow-md' : 'hover:text-primary-text hover:bg-background'}`}
                                >
                                    Edit Details
                                </motion.li>
                            </ul>
                ...
                <AnimatePresence mode="wait">
                    {activeTab === 'analytics' && (
                        <motion.div 
                            ...
                            className='flex flex-col justify-center items-start w-[80vw]'
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
                                <motion.div 
                                    ...
                                    className="statics flex flex-col justify-center gap-2 col-span-1 lg:col-span-2 bg-card px-6 py-6 rounded-2xl border border-border shadow-sm relative group overflow-hidden transition-shadow duration-300 hover:shadow-glow"
                                >
                                ...
                                <motion.div 
                                    variants={itemVariants}
                                    whileHover={{ scale: 1.02 }}
                                    className="stat-box bg-card px-5 py-5 rounded-2xl border border-border shadow-sm flex flex-col justify-between relative group overflow-hidden transition-shadow duration-300 hover:shadow-glow"
                                >
                    ...
                    {activeTab === 'portfolio' && (
                        ...
                        >
                            <motion.div variants={itemVariants} className="flex items-center self-start gap-4 mb-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                                ...
                                <motion.div variants={itemVariants} className="flex flex-col bg-card p-6 rounded-2xl border border-border shadow-sm relative group overflow-hidden">
                                    ...
                                    <div className="flex justify-between items-center z-10 mb-4">
                                        ...
                                        <div className="flex gap-2">
                                            {editModes.details ? (
                                                <>
                                                    <motion.button whileTap={{ scale: 0.9 }} onClick={() => handleSave('details')} disabled={isSaving} className="p-2 bg-green-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                        <SaveIcon />
                                                    </motion.button>
                                                    <motion.button whileTap={{ scale: 0.9 }} onClick={() => handleCancel('details')} disabled={isSaving} className="p-2 bg-red-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                        <CancelIcon />
                                                    </motion.button>
                                                </>
                                            ) : (
                                                <motion.button whileTap={{ scale: 0.9 }} onClick={() => setEditModes(p => ({ ...p, details: true }))} className="p-2 bg-blue-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                    <EditIcon />
                                                </motion.button>
                                            )}
                                        </div>
                                ...
                                <motion.div variants={itemVariants} className="flex flex-col bg-card p-6 rounded-2xl border border-border shadow-sm relative group overflow-hidden">
                                    ...
                                    <div className="flex justify-between items-center z-10 mb-4">
                                        ...
                                        <div className="flex gap-2">
                                            {editModes.about ? (
                                                <>
                                                    <motion.button whileTap={{ scale: 0.9 }} onClick={() => handleSave('about')} disabled={isSaving} className="p-2 bg-green-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                        <SaveIcon />
                                                    </motion.button>
                                                    <motion.button whileTap={{ scale: 0.9 }} onClick={() => handleCancel('about')} disabled={isSaving} className="p-2 bg-red-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                        <CancelIcon />
                                                    </motion.button>
                                                </>
                                            ) : (
                                                <motion.button whileTap={{ scale: 0.9 }} onClick={() => setEditModes(p => ({ ...p, about: true }))} className="p-2 bg-blue-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                    <EditIcon />
                                                </motion.button>
                                            )}
                                        </div>
                                ...
                                <motion.div variants={itemVariants} className="flex flex-col bg-card p-6 rounded-2xl border border-border shadow-sm relative group overflow-hidden">
                                    ...
                                    <div className="flex justify-between items-center z-10 mb-4">
                                        ...
                                        <div className="flex gap-2">
                                            {editModes.contacts ? (
                                                <>
                                                    <motion.button whileTap={{ scale: 0.9 }} onClick={() => handleSave('contacts')} disabled={isSaving} className="p-2 bg-green-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                        <SaveIcon />
                                                    </motion.button>
                                                    <motion.button whileTap={{ scale: 0.9 }} onClick={() => handleCancel('contacts')} disabled={isSaving} className="p-2 bg-red-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                        <CancelIcon />
                                                    </motion.button>
                                                </>
                                            ) : (
                                                <motion.button whileTap={{ scale: 0.9 }} onClick={() => setEditModes(p => ({ ...p, contacts: true }))} className="p-2 bg-blue-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                    <EditIcon />
                                                </motion.button>
                                            )}
                                        </div>
                                ...
                                <motion.div variants={itemVariants} className="flex flex-col bg-card p-6 rounded-2xl border border-border shadow-sm relative group overflow-hidden">
                                    ...
                                    <div className="flex justify-between items-center z-10 mb-4">
                                        ...
                                        <div className="flex gap-2">
                                            {editModes.links ? (
                                                <>
                                                    <motion.button whileTap={{ scale: 0.9 }} onClick={() => handleSave('links')} disabled={isSaving} className="p-2 bg-green-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                        <SaveIcon />
                                                    </motion.button>
                                                    <motion.button whileTap={{ scale: 0.9 }} onClick={() => handleCancel('links')} disabled={isSaving} className="p-2 bg-red-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                        <CancelIcon />
                                                    </motion.button>
                                                </>
                                            ) : (
                                                <motion.button whileTap={{ scale: 0.9 }} onClick={() => setEditModes(p => ({ ...p, links: true }))} className="p-2 bg-blue-500 rounded-full text-white hover:scale-110 shadow-md transition-transform">
                                                    <EditIcon />
                                                </motion.button>
                                            )}
                                        </div>
