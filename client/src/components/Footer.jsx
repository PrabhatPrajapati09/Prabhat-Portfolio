...
const Footer = ({ data, setPortfolioData }) => {
    ...
    return (
        <div className="bg-background w-full h-fit px-6 sm:px-12 md:px-16 lg:px-24 transition-colors duration-300 overflow-hidden">
            ...
            >
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-between gap-4 py-6 text-center sm:text-left">
                    <div>
                        <div
                    ...
                    <div className="links flex items-center gap-3 text-primary-text">
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="github cursor-pointer bg-card p-2 rounded-xl transition-colors duration-300 border border-border/40">
                        ...
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="linkedin cursor-pointer bg-card p-2 rounded-xl text-primary-text transition-colors duration-300 border border-border/40">
                ...
                <motion.div variants={itemVariants} className="w-full h-[1px] bg-border/60"></motion.div>

                <motion.div variants={itemVariants} className="text-secondary-text py-5 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="copyright text-xs hover:text-disabled-button text-center md:text-left transition-colors duration-300 order-2 md:order-1">
                    ...
                    <div className="info flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-6 text-xs order-1 md:order-2 w-full sm:w-auto">
                        <p className="flex items-center gap-1.5 hover:text-disabled-button cursor-pointer transition-colors">
                        ...
                        <p className="flex items-center hover:text-disabled-button cursor-pointer transition-colors">
                        ...
                        <p className="flex items-center gap-1.5 cursor-pointer hover:text-disabled-button transition-colors">
                ...
                {isModalOpen && (
                    <div className="fixed inset-0 flex items-center justify-center z-[100] px-4">
                        ...
                        <motion.div 
                            ...
                            className="bg-background border border-border p-6 md:p-8 rounded-2xl w-full max-w-md shadow-2xl relative z-10"
                        >
